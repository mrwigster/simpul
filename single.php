...
<main class="content">
    <article class="container">
        ...
        <blockquote>
            <h3>Blockquote</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti quam laborum tenetur nemo ab sed impedit ratione! Corrupti, ipsam eveniet sit, dignissimos ducimus sequi enim, fuga nesciunt itaque exercitationem suscipit!</p>
        </blockquote>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic laborum et minus incidunt labore id dolorem delectus, velit cupiditate ab possimus libero, eum ipsum iusto consequuntur nisi vero nobis inventore!</p>
        <code>HR:</code>
        <hr>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic laborum et minus incidunt labore id dolorem delectus, velit cupiditate ab possimus libero, eum ipsum iusto consequuntur nisi vero nobis inventore!</p>
